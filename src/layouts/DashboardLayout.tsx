  ...
  return (
    <div className="flex flex-col md:flex-row h-screen overflow-hidden bg-card font-sans">
      <div className="w-full h-full flex flex-col md:flex-row overflow-hidden">
        ...
        {/* Main Content Area */}
        <main className="flex-1 flex flex-col min-w-0 overflow-hidden bg-[#fcfaf5] relative">
          <div className="flex-1 overflow-y-auto p-4 md:pt-10 md:pl-10 md:pr-6 pb-24 md:pb-10">
            <Outlet />
          </div>
          {showNotifPanel && (
